...
if token_from_params:
    ...
    st.success("Signed up via social login! Redirecting...")
    st.switch_page("pages/1_Dashboard.py")

import urllib.parse
_base = st.query_params.get("_host_url", "http://localhost:8501")
REDIRECT_URL = f"{_base}Sign_Up"
...
# ── JS: capture OAuth hash fragment ──
st.markdown("""
<script>
(function() {
...
with left_col:
    ...
    <div style="text-align:center;margin-top:1.25rem;">
      <div style="font-size:0.78rem;color:{t['text2']};margin-bottom:0.65rem;">
        Or sign up directly using:
      </div>
      <div class="social-row">
        <a class="soc-btn soc-google" title="Google"
        ...
        <a class="soc-btn soc-linkedin" title="LinkedIn"
